...
public class R02for
{
	...
	public static void main(String[] args)
	{
		 ...
		 */
		//시나리오1] 1~10까지의 합을 구하는 while문을 작성하시오.
		int a = 1;
		int total = 0;
		while(a<=10) {
			total += a;
		...
		System.out.println("1부터10까지 합:"+ total);
		...
		for(int c=0 ; c<=10 ; c++) {
			for(int d=0 ; d<=10 ; d++) {
				if((2*c)+(4*d)==12) {
					System.out.printf("2c+4d=12를 만족하는 c,d:%d, %d\n", c, d);
				}
			}
		}
