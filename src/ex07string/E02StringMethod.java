...
public class E02StringMethod
{
	...
	public static void main(String[] args)
	{
		 ...
		 */
		System.out.println("str1의길기:"+ str1.length());
		System.out.println("str2의길기:"+ str2.length());
		
		/*
		2] charAt(인덱스) : 문자열에서 특정 index에 해당하는 문자
			하나를 반환한다. index 배열과 같이 0부터 시작한다.
		 */
		System.out.println("str1의 두번째 문자:"+ str1.charAt(1));
		System.out.println("str2의 두번째 문자:"+ str2.charAt(1));
		
		/*
		시나리오] 주민등록번호를 이용하여 성별을 판단다는
		프로그램을 작성하시오.
		190419-3000000 => 남자
		190419-4000000 => 여자
		 */
		...
		*/
		...
		작성하시오.
		파일명 : my.file.images.ipg
		 */
		String filename = "my.file.images.ipg";
		...
		System.out.println("str1 첫번째 문자의 아스키코드:"
				+ str1.codePointAt(0));
		System.out.println("str2 첫번째 문자의 아스키코드:"
				+ str2.codePointAt(0));
